...
//CQs list of cqs ever created
var CQs map[string]ContinuousQuery
...
//DropACQs drop a cq with provided cqname
func DropACQs(c client.Client, sugar *zap.SugaredLogger, cqName string) error {
	var (
		logger = sugar.With(
