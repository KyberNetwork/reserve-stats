...
func (is *Storage) GetReserveVolume(rsvAddr ethereum.Address, token ethereum.Address,
...
func (is *Storage) GetAssetVolume(token ethereum.Address, fromTime, toTime time.Time,
